...
" TOOO: clean up plugins, clean up all the old stuff
...
"set rtp+=~/.vim/localPlugins/vim-mql5
" this bad boy needs to be compile -> see 
"Plugin 'phaubos/vim-mql4'
"Plugin 'vobornik/vim-mql4'
"Plugin 'https://github.com/paradigm/SkyBison.git'
"Plugin 'kien/ctrlp.vim'
"Plugin 'https://github.com/vim-scripts/vimwiki.git'
"Plugin 'jcf/vim-latex.git'
"Plugin 'scrooloose/nerdtree'
"Plugin 'ervandew/supertab'
"### snipmate branch of garbas
"Dependencies
"Plugin 'MarcWeber/vim-addon-mw-utils'
"Plugin 'tomtom/tlib_vimx"
"Plugin 'honza/snipmate-snippets'
"Plugin itself
"### end snipmate branch of garbas
"Plugin 'sjbach/lusty'
...
"let g:neomake_python_enabled_makers = ['pycodestyle', 'flake8', 'pydocstyle'] 
